...
DEFAULT_PARSER_DIR = _get(
    "paths", "stars_parser_dir", "STARS_PARSER_DIR", "/path/to/stars_file_parser/target/debug"
)
DEFAULT_RESEARCH_DIR = _get(
    "paths", "stars_research_dir", "STARS_RESEARCH_DIR", "/path/to/stars-reborn-research"
)
